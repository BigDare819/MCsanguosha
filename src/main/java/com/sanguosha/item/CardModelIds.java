...
public final class CardModelIds {
    ...
    private static final String[] HERO_KEYS = {
        ...
        "zhaoyun","zhenji","zhugeliang","zhouyu","nailong","zhangxuefeng","jiexusheng","shencaocao","shenzhaoyun","lidian","lvdai","liuzan","longyufei","jiehuatuo","jiecaocao","jiedaqiao","jiediaochan","jieguanyu","jieguojia","jiehuaxiong","jiehuanggai","jiehuangyueying","jieliubei","jieluxun","jielvbu","jiemachao","jiesimayi","jiesunquan","jiesunshangxiang","jiexiahoudun","jiexuchu","jieyuanshu","jiezhangfei","jiezhangliao","jiezhaoyun","jiezhenji","jiezhouyu","jiezhugeliang","jieganning","big"
    };
