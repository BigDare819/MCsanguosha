...
public final class ModKeybinds {
    public static final KeyMapping HP_UP = new KeyMapping("key.sanguosha.hp_up", GLFW.GLFW_KEY_X, "key.categories.sanguosha");
    public static final KeyMapping HP_DOWN = new KeyMapping("key.sanguosha.hp_down", GLFW.GLFW_KEY_Z, "key.categories.sanguosha");
    ...
    public static final KeyMapping CLEAR_CARDS = new KeyMapping("key.sanguosha.clear_cards", GLFW.GLFW_KEY_V, "key.categories.sanguosha");
